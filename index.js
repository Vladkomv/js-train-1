...
function isPositiveNumber(num) {
  let a = num > 0 ? true : false; // Перевіряємо, чи число num більше 0
  return a; // Якщо так, то num є позитивним, тому повертаємо true
...
function isEmptyString(str) {
  let a = str === "" ? true : false; // Перевіряємо, чи рядок str дорівнює пустому рядку ('')
  return a; // Якщо так, то str є порожнім рядком, тому повертаємо true
...
function checkDataType(value) {
  let a = typeof value; // Отримуємо тип значення value за допомогою оператора typeof
  return `Значення ${value} має тип ${a}`; // Виводимо у консоль повідомлення, яке містить значення value та його тип
...
function getVariableType(variable) {
  let a = typeof variable; // Отримуємо тип змінної variable за допомогою оператора typeof
...
// console.log(double(increment(5)));
